...
For example, if you were connecting to Twitter, you would want a com.codepath.apps.mytwitter.models.Tweet model as follows:

```java
// models/com.codepath.apps.mytwitter.models.Tweet.java
...
@Table(name = "Tweets")
public class com.codepath.apps.mytwitter.models.Tweet extends Model {
  ...
  public com.codepath.apps.mytwitter.models.Tweet() {
    super();
  }
}
```
...
public class com.codepath.apps.mytwitter.models.Tweet extends Model {
  ...
  public com.codepath.apps.mytwitter.models.Tweet(JSONObject object){
    super();
  ...
  public static ArrayList<com.codepath.apps.mytwitter.models.Tweet> fromJson(JSONArray jsonArray) {
    ArrayList<com.codepath.apps.mytwitter.models.Tweet> tweets = new ArrayList<com.codepath.apps.mytwitter.models.Tweet>(jsonArray.length());
    ...
    for (int i=0; i < jsonArray.length(); i++) {
        ...
        com.codepath.apps.mytwitter.models.Tweet tweet = new com.codepath.apps.mytwitter.models.Tweet(tweetJson);
        tweet.save();
        tweets.add(tweet);
    }
...
```java
ArrayList<com.codepath.apps.mytwitter.models.Tweet> tweets = com.codepath.apps.mytwitter.models.Tweet.fromJSON(jsonArray);
```

or load the data from a single `JSONObject` with:

```java
com.codepath.apps.mytwitter.models.Tweet t = new com.codepath.apps.mytwitter.models.Tweet(json);
// t.body = "foo"
t.save();
```
